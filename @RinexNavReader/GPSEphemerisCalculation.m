function [satPos,satVel,satClock] = GPSEphemerisCalculation(obj,ephemerisSet,transmitTime,transitTime)
...
% time.
%
% The code assumes that the ephemerisSet is in a structure in the format
...
T_GD                =ephemerisSet.TGD;     
t_oc                =ephemerisSet.TOC;     
a_f2                =ephemerisSet.a2;     
a_f1                =ephemerisSet.a1;
a_f0                =ephemerisSet.a0;
C_rc                =ephemerisSet.Crc;
C_rs                =ephemerisSet.Crs;
C_uc                =ephemerisSet.Cuc;
C_us                =ephemerisSet.Cus;
C_ic                =ephemerisSet.Cic;
C_is                =ephemerisSet.Cis;
Delta_n             =ephemerisSet.deltaN;
M_0                 =ephemerisSet.M0;
e                   =ephemerisSet.e;
...
%--- Report satellite coordinates ------------------------------------
% Include relativistic correction in clock correction -----------------
satPos = [x,y,z];
satVel = [xdot,ydot,zdot];
satClock = (a_f2 * dt + a_f1) * dt + a_f0 - T_GD + dtr;
